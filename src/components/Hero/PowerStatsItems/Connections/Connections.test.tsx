...
test("render content", () => {
  const connections = {
    "group-affiliation":
      "Justice League of America, The Legion of Super-Heros (pre-Crisis as Superboy); Justice Society of America (pre-Crisis Earth-2 version); All-Star Squadron (pre-Crisis Earth-2 version)",
    relatives:
